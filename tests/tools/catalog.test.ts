...
describe('Arkme tool catalog', () => {
  ...
  it('separates registration phase from business kind and write policy', () => {
    ...
    expect(writes.map(module => module.meta.toolName)).toEqual([
      ...
      'arkme_world_voiceprint_invite', 'arkme_voiceprint_recognized_person_invite', 'arkme_voiceprint_invite', 'arkme_voiceprint_revoke', 'arkme_voiceprint_restore_playback',
